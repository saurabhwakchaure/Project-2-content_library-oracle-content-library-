...
<body>
  <div class="hero_area">
    ...
    <div class="container">
        <h6 class="my-4">The following Customer's has a Query:</h6>
        <table class="table custom-table">
            ...
            <?php
                  foreach($detail as $demo)
                  {
                      ...
                      ?>
                      <td><a href="printQuery/<?= $demo['id']; ?>"><button type="button" class="btn btn-info" title="book">Approv</button></a></td>
                      <td><a href="deleteQuery/<?= $demo['id']; ?>"><button type="button" class="btn btn-danger" title="book">Delete</button></a></td>
